...
@NoArgsConstructor
@AllArgsConstructor
@Table(name="leisure_sports")
public class leisure_sports {
    ...
    @Column(name = "operating_period",updatable = false,columnDefinition="TEXT")
    ...
    @Column(name = "target_age",updatable = false,columnDefinition="TEXT")
