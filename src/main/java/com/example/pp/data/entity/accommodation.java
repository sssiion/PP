...
public class accommodation {
    ...
    @Column(name = "room_count",updatable = false)
    private String room_count;

    @Column(name = "room_type",updatable = false)
    private String room_type;

    @Column(name = "parking_availability",updatable = false)
    private String parking_availability;

    @Column(name = "cooking_availability",updatable = false)
    ...
    @Column(name = "reservation_page",updatable = false)
    private String reservation_page;

    @Column(name = "pickup_service",updatable = false)
    private String pickup_service;

    @Column(name = "fnb_area",updatable = false)
    private String fnb_area;

    @Column(name = "amenities",updatable = false)
    private String amenities;

    @Column(name = "seminar_room",updatable = false)
    private String seminar_room;

    @Column(name = "sports_facility",updatable = false)
    private String sports_facility;

    @Column(name = "sauna_room",updatable = false)
    private String sauna_room;

    @Column(name = "beauty_facility",updatable = false)
    private String beauty_facility;

    @Column(name = "karaoke_room",updatable = false)
    private String karaoke_room;

    @Column(name = "barbecue_area",updatable = false)
    private String barbecue_area;

    @Column(name = "campfire_area",updatable = false)
    private String campfire_area;

    @Column(name = "bicycle_rack",updatable = false)
    private String bicycle_rack;

    @Column(name = "fitness_center",updatable = false)
    private String fitness_center;

    @Column(name = "public_pc_room",updatable = false)
    private String public_pc_room;

    @Column(name = "public_shower_room",updatable = false)
    private String public_shower_room;

    @Column(name = "detailed_info",updatable = false)
    private String detailed_info;

    @Column(name = "refund_policy",updatable = false)
